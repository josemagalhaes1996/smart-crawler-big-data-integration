...
public class Connections implements Serializable {
    ...
    public Connections() {
        ...
        this.conf = new SparkConf().setAppName("ProfilerApp").setMaster("master").set("spark.driver.allowMultipleContexts", "true").set("spark.debug.maxToStringFields", "10000").set("spark.sql.crossJoin.enabled", "true");
